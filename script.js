...
function reportWin(rowNum,colNum) {
  console.log("Ha ganado empezando en esta fila, columna");
  console.log(rowNum);
  console.log(colNum);
}
...
$('h3').text(player1+" es tu turno, selecciona una columna para tirar")
...
$('.board button').click( function(){
  ...
  if (horizontalWinCheck() || verticalWinCheck() || diagonalWinCheck()){
    $('h1').text(currentName+ ' has ganado!');
    $('h3').fadeOut('fast');
    $('h2').fadeOut('fast');
  }
  ...
  if (currentPlayer ===1) {
    currentName = player1;
    $('h3').text(currentName + " es tu turno")
